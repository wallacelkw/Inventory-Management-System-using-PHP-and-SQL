                    ...
                    <table class="table table-striped table-bordered" id="data_table" width="100%">
                        ...
                        <tr>
                            ...
                            <td><a class="btn edit-btn btn_color"
                                    href="invoice sale_admin.php?id=<?php echo $row['sale_id'];?>"><i
                                        class="fa fa-edit"></button></i></a></td>
                            <td><a class="btn trash-btn btn_color" href="view sale_admin.php?id=<?php echo $row['sale_id'];?>"
...
if(isset($_GET['id'])) 
{
  ...
  ?>
    ...
    window.location.href = 'view sale_admin.php';
    </script>
