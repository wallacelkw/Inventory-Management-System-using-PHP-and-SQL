                    ...
                    <div class="col-md-10 p-5" style="margin:0px 0px 0px 20px;">
                        ...
                        <form method="POST">
                            ...
                            <div class="container-fluid">
                                ...
                                <input class="form-control" type="text" id="current_pass" name="current_pass"
                                    placeholder="Enter your current password..." style="width: 500px;" required>
                                <br>
                                <label for="new_pass">New Password</label>
                                <input class="form-control" type="text" id="new_pass" name="new_pass"
                                    placeholder="Enter your new password...(MAX 15 CHARACTERS)" maxlength="15"
                                ...
                                <input class="form-control" type="text" id="cnew_pass" name="cnew_pass"
                                    placeholder="Confirm your new password...(MAX 15 CHARACTERS)" maxlength="15"
                                    style="width: 500px;" required>
                                <br><br>

                                <input class="btn btn-primary btn-color" type="submit" name="submit"
                                    value="Change New Password">
                        </form>
    ...
    if($cpass == $pass)
    {
        if($npass == $cnpass)
        {
            if($cpass == $npass || $cpass == $cnpass)
            {
                ...
                echo "<script>document.location='change_pass_admin.php'
                </script>";
            }
            else
            {
