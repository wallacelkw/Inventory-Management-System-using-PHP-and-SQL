...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
        ...
        <div id="product_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="add product.php">New Product</a>
                <a class="collapse-item" href="view product.php">Search Product</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item active">
        ...
        <div id="customer_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="customer.php">New Customer</a>
                <a class="collapse-item" href="customer_manage.php">Search Customer</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item active">
        ...
        <div id="supplier_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="supplier.php">New Supplier</a>
                <a class="collapse-item" href="supplier_manage.php">Search Supplier</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item active">
        ...
        <div id="sales_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="add sale.php">New Sales</a>
                <a class="collapse-item" href="view sale.php">Search Sales</a>
            </div>
        </div>
    </li>
